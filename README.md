...
|---|---|---|
| [**pmf-signal**](https://github.com/AnkitaSontakke/pmf-signal)<br>Turns a CSV of user feedback into a ranked list of the problems behind it | ⭐ 0 | 1 month ago |
| [**roadmap-to-content**](https://github.com/AnkitaSontakke/roadmap-to-content)<br>Reads a GitHub project board and returns a four-week content plan that never promises unshipped features | ⭐ 0 | 1 month ago |
| [**humanize-writing**](https://github.com/AnkitaSontakke/humanize-writing)<br>A Claude Code skill and a linter that strip AI writing tells out of prose. Runs in CI, scores a draft out of 100 | ⭐ 0 | 1 month ago |
| [**launch-loop**](https://github.com/AnkitaSontakke/launch-loop)<br>The launch system behind 32k GitHub stars in 14 days, plus a tool that measures whether a spike turned into a loop | ⭐ 0 | 1 month ago |
| [**medulla**](https://github.com/AnkitaSontakke/medulla)<br>A LLM model focused on high concurrency orchestration | ⭐ 0 | 2 months ago |
<!-- PORTFOLIO:REPOS:END -->

### Latest

<!-- PORTFOLIO:ACTIVITY:START -->
_Nothing public in the last 90 days._
